  ...
  return (
    <div className="bg-white border rounded-lg p-4 flex items-start gap-3">
      ...
      <div className="min-w-0">
        ...
        <span className="inline-block mt-1 text-[10px] px-2 py-0.5 rounded-full bg-secondary text-secondary-foreground">{qual}</span>
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div>
      <h3 className="text-lg font-bold text-[color:var(--navy)] mb-3 border-b-2 border-[color:var(--gold)] inline-block pb-1">{title}</h3>
    ...
    <PageLayout>
      ...
      <div className="container mx-auto px-4 py-10 space-y-10">
        ...
        <Section title="Workshop">
          <Card name="Workshop Superintendent" designation="Vacant" qual="—" />
        </Section>
